...
BLACK_KING   = pygame.image.load('chess game simple/images/black_king.png')
BLACK_QUEEN  = pygame.image.load('chess game simple/images/black_queen.png')
BLACK_ROOK   = pygame.image.load('chess game simple/images/black_rook.png')
BLACK_BISHOP = pygame.image.load('chess game simple/images/black_bishop.png')
BLACK_KNIGHT = pygame.image.load('chess game simple/images/black_knight.png')
BLACK_PAWN   = pygame.image.load('chess game simple/images/black_pawn.png')
BLACK_JOKER  = pygame.image.load('chess game simple/images/black_joker.png')

WHITE_KING   = pygame.image.load('chess game simple/images/white_king.png')
WHITE_QUEEN  = pygame.image.load('chess game simple/images/white_queen.png')
WHITE_ROOK   = pygame.image.load('chess game simple/images/white_rook.png')
WHITE_BISHOP = pygame.image.load('chess game simple/images/white_bishop.png')
WHITE_KNIGHT = pygame.image.load('chess game simple/images/white_knight.png')
WHITE_PAWN   = pygame.image.load('chess game simple/images/white_pawn.png')
WHITE_JOKER  = pygame.image.load('chess game simple/images/white_joker.png')
...
pygame.display.set_icon(pygame.image.load('chess game simple/images/chess_icon.ico'))
